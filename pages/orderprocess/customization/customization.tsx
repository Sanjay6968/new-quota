...
const defaultCustomizationDetails: CustomizationDetails = {
...
function CustomizeDetails({ 
  ...
  customizationDetails = defaultCustomizationDetails, 
  ...
  }, [dimensions, customizationDetails, onCustomizationChange]);
  ...
  const handleNextButtonClick = async () => {
    ...
    try {
      ...
      const orderId = typeof localStorage !== 'undefined' ? localStorage.getItem('orderId') : null;
