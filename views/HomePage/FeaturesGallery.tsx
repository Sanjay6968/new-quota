...
const TABS = [
  ...
  {
    title: 'Akar 200 - Desktop Printer',
    description:
      '<p>A professional desktop 3D printer featuring a 250x200x300 mm³ print volume, filament runout recovery, and the most reliable printer. Perfect for schools and small teams</p>',
    videoUrl: 'https://www.youtube.com/embed/PStyi4pujgs',
    baseColor: '37,123,242',
    secondColor: '102,161,246',
  },
];
